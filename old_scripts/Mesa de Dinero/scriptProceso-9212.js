    ...
    if (r_co_maeban == null) {
        ...
        if(v_va_resqry.co_estado == '00'){
            ...
            var mensajeCorreo = `{
                ...
                "para": ["luis.cubas@acceso.com.pe"],
                "cc": ["mesadinero@acceso.com.pe"],
                "asunto": "Visado Pendiente de Cuenta Bancaria ",
                "mensaje": "Usted cuenta con una nueva cuenta bancaria pendiente de evaluación en el sistema Mesa de Dinero."
            }`;
